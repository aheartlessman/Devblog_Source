...
public class Render {
    ...
    public static void Line(float x1, float y1, float x2, float y2, Color color, float thickness = 1f)
    {
        ...
        // Рисуем прямоугольник, повернутый под нужным углом
        RectFilled(x1, y1, length, thickness, color);
